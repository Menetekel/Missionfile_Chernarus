...
//GermanDayZ.de Diiedeli
//MedicalSupplies
if (true) then
{
  _this = _group_1 createUnit ["RU_Assistant", [4079.8589, 11693.767, 0.96684074], [], 0, "CAN_COLLIDE"];
  _unit_100 = _this;
  _this setDir -85.507805;
...
if (true) then
{
  _this = _group_1 createUnit ["TK_CIV_Worker01_EP1", [4070.8879, 11671.746, -3.0517578e-005], [], 0, "CAN_COLLIDE"];
  _unit_101 = _this;
  _this setDir 114.10786;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
  _this allowDammage false; _this disableAI 'FSM'; _this disableAI 'MOVE'; _this disableAI 'AUTOTARGET'; _this disableAI 'TARGET'; _this setBehaviour 'CARELESS'; _this forceSpeed 0;_this enableSimulation false;
};
...
if (true) then
{
  _this = _group_1 createUnit ["TK_CIV_Woman01_EP1", [4072.9421, 11694.224], [], 0, "CAN_COLLIDE"];
  _unit_102 = _this;
  _this setDir 76.802193;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
  _this allowDammage false; _this disableAI 'FSM'; _this disableAI 'MOVE'; _this disableAI 'AUTOTARGET'; _this disableAI 'TARGET'; _this setBehaviour 'CARELESS'; _this forceSpeed 0;_this enableSimulation false;
};
...
if (true) then
{
  _this = _group_1 createUnit ["Functionay2_EP1", [4080.325, 11701.316, -3.0517578e-005], [], 0, "CAN_COLLIDE"];
  _unit_103 = _this;
  _this setDir -129.0047;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
  _this allowDammage false; _this disableAI 'FSM'; _this disableAI 'MOVE'; _this disableAI 'AUTOTARGET'; _this disableAI 'TARGET'; _this setBehaviour 'CARELESS'; _this forceSpeed 0;_this enableSimulation false;
};
...
if (true) then
{
  _this = _group_1 createUnit ["TK_CIV_Woman03_EP1", [4073.3037, 11685.515, 0.96919608], [], 0, "CAN_COLLIDE"];
  _unit_104 = _this;
  _this setDir -269.79147;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
  _this allowDammage false; _this disableAI 'FSM'; _this disableAI 'MOVE'; _this disableAI 'AUTOTARGET'; _this disableAI 'TARGET'; _this setBehaviour 'CARELESS'; _this forceSpeed 0;_this enableSimulation false;
};
...
if (true) then
{
  _this = _group_1 createUnit ["Citizen2_EP1", [4080.9446, 11685.784, 0.010591336], [], 0, "CAN_COLLIDE"];
  _unit_105 = _this;
  _this setDir 270.63309;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
  _this allowDammage false; _this disableAI 'FSM'; _this disableAI 'MOVE'; _this disableAI 'AUTOTARGET'; _this disableAI 'TARGET'; _this setBehaviour 'CARELESS'; _this forceSpeed 0;_this enableSimulation false;
};
...
if (true) then
{
  _this = _group_1 createUnit ["Worker3", [4041.6206, 11668.891, 0.23954971], [], 0, "CAN_COLLIDE"]; //4041 Vehicle Trader Bash
  _unit_56 = _this;
...
if (true) then
{
  _this = createVehicle ["HeliHEmpty", [1618.3326, 7773.1138, 6.1035156e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_659 = _this;
  _this setPos [1618.3326, 7773.1138, 6.1035156e-005];
};
...
if (true) then
{
  _this = createVehicle ["HeliHEmpty", [6293.1499, 7806.269], [], 0, "CAN_COLLIDE"];
  _vehicle_678 = _this;
  _this setPos [6293.1499, 7806.269];
};
...
if (true) then
{
  _this = createVehicle ["Land_BagFenceRound", [6295.7954, 7804.1538], [], 0, "CAN_COLLIDE"];
  _vehicle_813 = _this;
  _this setDir 128.79018;
  _this setPos [6295.7954, 7804.1538];
};

_vehicle_819 = objNull;
if (true) then
{
  _this = createVehicle ["HeliHEmpty", [12974.582, 12755.237], [], 0, "CAN_COLLIDE"];
  _vehicle_819 = _this;
  _this setPos [12974.582, 12755.237];
};
