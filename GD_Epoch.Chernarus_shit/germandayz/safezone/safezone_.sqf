...
while {true} do {
	 ...
	 //use if thing because waitUntil could stuck //Skaronator
	if (inSafeZone) then {
...
//    titleText [format["Exiting Safe Zone!"],"PLAIN DOWN"]; titleFadeOut 4;
    ...
    player_zombieCheck = compile preprocessFileLineNumbers "\z\germandayz\AI\dayz_code\compile\player_zombieCheck.sqf";
    player_fired = compile preprocessFileLineNumbers "\z\germandayz\AI\dayz_code\compile\player_fired.sqf";
    fnc_usec_damageHandler = compile preprocessFileLineNumbers "\z\germandayz\AI\dayz_code\compile\fn_damageHandler.sqf";
