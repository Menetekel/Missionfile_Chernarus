...
"norrnRaLW"					addPublicVariableEventHandler {[_this select 1] execVM "\z\germandayz\AI\dayz_code\medical\publicEH\load_wounded.sqf"};
"norrnRLact"				addPublicVariableEventHandler {[_this select 1] execVM "\z\germandayz\AI\dayz_code\medical\load\load_wounded.sqf"};
"norrnRDead"				addPublicVariableEventHandler {[_this select 1] execVM "\z\germandayz\AI\dayz_code\medical\publicEH\deadState.sqf"};
...
if (!isDedicated) then {
	...
	"norrnRaDrag"			addPublicVariableEventHandler {[_this select 1] execVM "\z\germandayz\AI\dayz_code\medical\publicEH\animDrag.sqf"};
	"norrnRnoAnim"			addPublicVariableEventHandler {[_this select 1] execVM "\z\germandayz\AI\dayz_code\medical\publicEH\noAnim.sqf"};
};