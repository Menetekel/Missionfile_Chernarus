...
dayz_animalDistance = 200; // Default = 200
dayz_zSpawnDistance = 600; // Default = 600
dayz_maxLocalZombies = 20; // Default = 30 
dayz_maxGlobalZombiesInit = 10; // Default = 10
dayz_maxGlobalZombiesIncrease = 5; // Default = 5
dayz_maxZeds = 200; // Default = 200
dayz_sellDistance = 35; // Default = 35
...
if (!isDedicated) then {
	...
	player_build = compile preprocessFileLineNumbers "germandayz\clientfiles\player_build.sqf"; //Line#140  ->  dayz_characterID >> dayz_playerUID
