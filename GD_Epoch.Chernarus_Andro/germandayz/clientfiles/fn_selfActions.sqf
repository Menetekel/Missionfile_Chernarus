...
if (inflamed cursorTarget and _canDo) then {
        ...
        s_player_dancea = player addAction [("<t color='#FFFF00'>" + ("Dance!") +"</t>"),"germandayz\firedance\dance1.sqf",cursorTarget, 0, false, true, "",""];
        s_player_danceb = player addAction [("<t color='#FFFF00'>" + ("Daddy!") +"</t>"),"germandayz\firedance\dance2.sqf",cursorTarget, 0, false, true, "",""];
        s_player_dancec = player addAction [("<t color='#FFFF00'>" + ("Fight!") +"</t>"),"germandayz\firedance\dance3.sqf",cursorTarget, 0, false, true, "",""];
		s_player_danced = player addAction [("<t color='#FFFF00'>" + ("Rock!") +"</t>"),"germandayz\firedance\dance4.sqf",cursorTarget, 0, false, true, "",""];
	};
} else {
...
// ------------------------------------------------------------------------Andro Take Clothes End------------------------------------------------------------------------
	...
	if ((_cursorTarget isKindOf "ModularItems") or (_cursorTarget isKindOf "Land_DZE_WoodDoor_Base") or (_cursorTarget isKindOf "CinderWallDoor_DZ_Base")) then {
		...
		if (s_player_upgrade_build < 0) then {
			...
			s_player_upgrade_build = player addAction [format["Upgrade %1",_text], "germandayz\clientfiles\player_upgrade.sqf",_cursorTarget, -1, false, true, "",""];
	...
	if((_isDestructable or _cursorTarget isKindOf "Land_DZE_WoodDoorLocked_Base" or _cursorTarget isKindOf "CinderWallDoorLocked_DZ_Base") and (DZE_Lock_Door == _ownerID)) then {
		...
		if (s_player_downgrade_build < 0) then {
			...
			s_player_downgrade_build = player addAction [format["Remove Lock from %1",_text], "germandayz\clientfiles\player_buildingDowngrade.sqf",_cursorTarget, -2, false, true, "",""];
