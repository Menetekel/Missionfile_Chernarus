...
if (!isDedicated) then {
	...
	//control_zombieAgent = 		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\control_zombieAgent.sqf"; //default off
	...
	player_knockout = compile preprocessFileLineNumbers "germandayz\knockout\knockout2.sqf";
	// -------------------- Andro Knockout End -------------------- 
	//ui
