...
call compile preprocessFileLineNumbers "skaronator\server_traders.sqf";				//Compile trader configs
...
if (isServer) then {
	...
	/* CUSTOM STUFF SKARONATOR START */
	_skaro = [] execVM "skaronator\safezone\safezone.sqf";
	//Clear Zeds
	[[4063.4226, 11664.19, 0],100] execVM "skaronator\safezone\clearZed.sqf"; //-> Bash
	[[11447.472, 11364.504, 0],100] execVM "skaronator\safezone\clearZed.sqf"; //-> Klen
	[[12944.227,12766.889, 0],100] execVM "skaronator\safezone\clearZed.sqf"; //-> Hero
	/* CUSTOM STUFF SKARONATOR END */
...
if (!isDedicated) then {
	...
	//_skaro = [] execVM "skaronator\login\loginCamera.sqf"; //Be Sure this is excluded !AFTER! 'waitUntil {!isNil "dayz_loadScreenMsg"};' !!!!!!!!
	_skaro = [] execVM "skaronator\playerUI\effects.sqf";
	_skaro = [] execVM "skaronator\refuel\refuel_selfActions.sqf";
