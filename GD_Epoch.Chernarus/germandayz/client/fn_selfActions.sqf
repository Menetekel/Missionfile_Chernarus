...
//		 	s_player_maintain_area_preview = player addAction ["<t color=""#ccffffff"">Maintain Area Preview</t>", "\z\addons\dayz_code\actions\maintain_area.sqf", "preview", 5, false];
		  	s_player_maintain_area = player addAction ["<t color=""#ffffff"">Maintain Area</t>", "germandayz\client\maintain_area.sqf", "maintain", 5, false];
		 	s_player_maintain_area_preview = player addAction ["<t color=""#ccffffff"">Maintain Area Preview</t>", "germandayz\client\maintain_area.sqf", "preview", 5, false];
		 };
	 } else {
