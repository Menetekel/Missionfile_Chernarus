...
SAR_AI_trace                      = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_trace_entities.sqf";
SAR_AI_trace_veh                  = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_trace_from_vehicle.sqf";
SAR_AI_hit                        = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_aihit.sqf";
...
SAR_AI_heli                 = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_setup_AI_patrol_heli.sqf";
SAR_AI_land                 = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_setup_AI_patrol_land.sqf";
SAR_AI_reammo               = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_reammo_refuel_AI.sqf";
SAR_AI_spawn                = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_AI_spawn.sqf";
SAR_AI_despawn              = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_AI_despawn.sqf";
SAR_AI_killed               = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_aikilled.sqf";
SAR_AI_UPSMON               = compile preprocessFileLineNumbers "germandayz\AI\UPSMON\scripts\upsmon.sqf";
SAR_AI_VEH_HIT              = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_ai_vehicle_hit.sqf";
SAR_AI_GROUP_MONITOR        = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_group_monitor.sqf";
SAR_AI_VEH_FIX              = compile preprocessFileLineNumbers "germandayz\AI\SARGE\SAR_vehicle_fix.sqf";
