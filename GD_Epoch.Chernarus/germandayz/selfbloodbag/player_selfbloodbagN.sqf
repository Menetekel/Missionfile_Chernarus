...
_bloodAmount = 3000; // Amount of blood to give to player
...
_infectionChance = 50; // Percent chance of player infection on self bloodbag (10 = 10% | 2 = 50% | 1 = 100%)
...
if (_inCombat) then { // Check if in combat
	...
	player removeAction s_player_selfBloodbagN; //remove the action from users scroll menu
